      ...
      <Page>
        <BeforeLayout>
          <div>
            ...
            <Select>사장님의 사업자등록증에 적힌 업종을 선택해주세요</Select>{" "}
            <br />
            <br />
          </div>
